...
char GenericRubiksCubeModel::getColorLetter(COLOR color) {
    switch (color) {
        case COLOR::BLUE:
            return 'B';
        case COLOR::GREEN:
 ...
 */
string GenericRubiksCubeModel::getMove(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return "L";
        case MOVE::LPRIME:
 ...
 */
GenericRubiksCubeModel &GenericRubiksCubeModel::move(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return this->l();
        case MOVE::LPRIME:
 ...
 * Invert a move.
 */
GenericRubiksCubeModel &GenericRubiksCubeModel::invert(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return this->lPrime();
        case MOVE::LPRIME:
...
void GenericRubiksCubeModel::print() const {
    cout << "Rubik's Cube:\n\n";
...
vector<GenericRubiksCubeModel::MOVE> GenericRubiksCubeModel::randomShuffleCube(unsigned int times) {
...
string GenericRubiksCubeModel::getCornerColorString(uint8_t ind) const {
    string str = "";
...
uint8_t GenericRubiksCubeModel::getCornerIndex(uint8_t ind) const {
...
uint8_t GenericRubiksCubeModel::getCornerOrientation(uint8_t ind) const {
    string corner = getCornerColorString(ind);
