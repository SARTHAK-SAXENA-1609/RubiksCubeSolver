...
bool PatternDatabase::setNumMoves(const GenericRubiksCubeModel &cube, const uint8_t numMoves) {
...
uint8_t PatternDatabase::getNumMoves(const GenericRubiksCubeModel &cube) const {
